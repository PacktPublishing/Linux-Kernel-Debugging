...
echo "sudo trace-cmd record -p function_graph -e net -e sock --module e1000 -F ping -c1 packtpub.com"
sudo trace-cmd record -p function_graph -e net -e sock --module e1000 -F ping -c1 packtpub.com
